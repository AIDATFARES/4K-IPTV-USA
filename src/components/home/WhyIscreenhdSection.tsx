...
const primaryFeatures = [
  ...
  { icon: Clapperboard, title: "200,000+ VODs", text: "Enjoy an on-demand library with movies, series, replays, highlights, and documentaries available any time, on any device.", tags: ["MOVIES", "SERIES", "REPLAYS", "UPDATED DAILY"], accent: "orange" },
];
...
const benefits = [
  ...
  { icon: Globe2, title: "Works Worldwide", text: "Enjoy iscreenhd wherever you are, on any connection.", color: "text-emerald-400" },
  { icon: ShieldCheck, title: "99.9% Uptime", text: "Reliable servers with stable, buffer-free streaming.", color: "text-indigo-300" },
];

export default function WhyIscreenhdSection() {
  return <section className="relative overflow-hidden bg-[#070914] py-24 sm:py-28">
    ...
    <div className="relative mx-auto max-w-[1120px] px-5 sm:px-8">
      <div className="mx-auto mb-14 max-w-3xl text-center">
        <span className="inline-flex rounded-full border border-indigo-400/35 bg-indigo-400/[0.06] px-4 py-1.5 text-[10px] font-extrabold uppercase tracking-[0.18em] text-indigo-300">Why choose iscreenhd IPTV?</span>
        <h2 className="mt-6 text-4xl font-black uppercase leading-[0.98] tracking-tight text-white sm:text-5xl"><span className="block">The Ultimate</span><span className="mt-1 block bg-gradient-to-r from-violet-400 via-indigo-400 to-cyan-400 bg-clip-text text-transparent">iscreenhd IPTV Experience</span></h2>
