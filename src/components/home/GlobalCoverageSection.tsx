      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10 mb-12">
        ...
        <div className="text-center mb-12">
          <motion.div
            ...
            viewport={{ once: true }}
            className="inline-flex items-center space-x-2 py-1.5 px-4 rounded-full border border-orange-500/30 bg-[#120b29] mb-6 shadow-[0_0_15px_rgba(6,182,212,0.15)]"
          >
          ...
          <AnimatePresence>
            {visibleCountries.map((country) => (
              <motion.div
                ...
                className="bg-[#0c0f1e]/90 border border-white/10 hover:border-orange-500/40 hover:bg-[#12162d] rounded-xl px-3.5 py-2.5 flex items-center gap-3 transition-all cursor-default group shadow-sm"
              >
                <img
                  src={`https://flagcdn.com/w40/${country.code}.png`}
        ...
        {filteredCountries.length > 24 && !isExpanded && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex justify-center mt-8">
            <button
              ...
              className="flex items-center space-x-2 px-6 py-2.5 rounded-full border border-white/15 bg-[#0c0f1e] text-xs font-bold text-stone-300 hover:text-white hover:border-orange-500/40 transition-colors shadow-md"
            >
