    ...
    <section className="w-full overflow-hidden bg-white py-16 relative flex flex-col gap-6">
      ...
      <div className="text-center mb-8 px-4 z-20">
        ...
        <h2 className="text-3xl md:text-5xl font-extrabold text-black mb-4 tracking-tight">
          THE ULTIMATE <span className="text-[#2E5BFF]">CINEMATIC</span> EXPERIENCE
        </h2>
        ...
        <Link 
          href="/channels"
          className="inline-flex items-center justify-center px-8 py-3 rounded-full border border-[#2E5BFF] text-black text-sm md:text-base font-medium bg-black/20 hover:bg-[#2E5BFF]/10 transition-colors duration-300 gap-2"
        >
