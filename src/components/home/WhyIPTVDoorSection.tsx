  ...
  return <section className="relative overflow-hidden bg-white py-24 sm:py-28">
    ...
    <div className="relative mx-auto max-w-[1120px] px-5 sm:px-8">
      <div className="mx-auto mb-14 max-w-3xl text-center">
        ...
        <h2 className="mt-6 text-4xl font-black uppercase leading-[0.98] tracking-tight text-black sm:text-5xl"><span className="block">The Ultimate</span><span className="mt-1 block bg-gradient-to-r from-orange-400 via-orange-400 to-orange-400 bg-clip-text text-transparent">IPTV Fiesta Experience</span></h2>
      ...
      <div className="grid gap-5 md:grid-cols-3">
        {primaryFeatures.map((feature, index) => {
          ...
          return <motion.article key={feature.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.1 }} className={`flex min-h-[285px] flex-col rounded-2xl border p-6 ${active ? "border-orange-400/70 bg-gradient-to-b from-orange-500/[0.12] to-white shadow-[0_0_32px_rgba(99,102,241,0.13)]" : "border-black/10 bg-white"}`}>
