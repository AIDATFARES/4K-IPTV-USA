      ...
      <div className="max-w-[1680px] mx-auto px-6 sm:px-10 lg:px-12 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 xl:gap-12 items-center w-full">
          ...
          <div className="w-full lg:col-span-5 flex flex-col items-center lg:items-start text-center lg:text-left gap-8">
            ...
            {/* Service badge */}
            <m.div {...fadeUp(0.1)} className="flex flex-wrap items-center gap-3">
            ...
            <m.h1 {...fadeUp(0.2)} className="w-full whitespace-normal break-normal text-5xl sm:text-6xl lg:text-6xl xl:text-[72px] font-extrabold tracking-[-0.06em] leading-[1.02] text-slate-100 font-sans">
            ...
            {/* Description */}
            <m.p {...fadeUp(0.3)} className="block w-full max-w-[620px] min-w-0 whitespace-normal break-normal [overflow-wrap:normal] text-pretty text-lg sm:text-xl leading-[1.65] text-slate-300 font-normal">
            ...
            {/* CTA buttons */}
            <m.div {...fadeUp(0.4)} className="flex flex-col sm:flex-row gap-4 w-full max-w-[600px] pt-3">
              <m.a
            ...
            <m.div {...fadeUp(0.5)} className="flex w-full max-w-[600px] flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm sm:text-base text-slate-400 lg:justify-start pt-2">
