    ...
    <section className="border-t border-black/10 bg-white px-5 py-16 sm:py-20 relative overflow-hidden">
      ...
      >
        <div className="max-w-[310px]">
          <span className="flex h-10 w-10 items-center justify-center rounded-xl border border-orange-500/35 bg-orange-500/10 text-orange-400">
          ...
          <h2 className="mt-5 text-3xl font-black uppercase italic leading-[0.9] tracking-tight text-black sm:text-4xl">
            ...
            <span className="block text-orange-500">question?</span>
          </h2>
        ...
        <div className="flex shrink-0 flex-col gap-2.5 sm:w-40">
          <a
            className="inline-flex items-center justify-center gap-2 rounded-full bg-emerald-600 px-4 py-2.5 text-[10px] font-extrabold uppercase tracking-wide text-black shadow-[0_0_20px_rgba(16,185,129,0.4)] transition-all hover:bg-emerald-500 hover:scale-105"
            href="https://wa.me/213552069874?text=Hello%2C%20I%20have%20a%20question%20about%20fiestaiptv%20IPTV."
            rel="noreferrer"
            target="_blank"
          >
