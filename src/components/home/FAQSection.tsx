      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-6 max-w-[1140px] mx-auto">
          {faqs.map((faq, index) => (
            <div
              key={faq.id}
              className="flex flex-col rounded-2xl overflow-hidden border border-black/10 bg-white shadow-xl hover:border-blue-500/40 transition-colors animate-fade-up"
