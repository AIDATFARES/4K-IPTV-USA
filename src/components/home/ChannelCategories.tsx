      ...
      <div className="mx-auto max-w-[1200px] px-5">
        ...
        <div className="mx-auto mb-12 max-w-4xl text-center">
          <div className="inline-flex items-center justify-center gap-2 mb-4">
            <span className="h-px w-8 bg-gradient-to-r from-transparent to-[#2E5BFF]"></span>
            <span className="text-[#2E5BFF] text-sm font-bold tracking-[0.2em] uppercase">Premium Quality</span>
            <span className="h-px w-8 bg-gradient-to-l from-transparent to-[#2E5BFF]"></span>
          </div>
          <h2 className="text-3xl md:text-5xl font-black text-black tracking-tight leading-tight animate-fade-up">
            ...
            <span className="text-[#2E5BFF]">Premium IPTV Service.</span>
          </h2>
        </div>

        {/* Orange Feature Box */}
        <div 
          className="bg-[#2E5BFF] rounded-2xl md:rounded-3xl p-8 md:p-12 mb-20 shadow-[0_10px_40px_rgba(255,107,0,0.3)] animate-fade-up"
              ...
              return (
                <div key={i} className="flex flex-col items-center">
                  <div className="mb-6 inline-flex p-4 rounded-full bg-white shadow-sm">
                    <Icon className="w-8 h-8 text-[#2E5BFF]" strokeWidth={2} />
                  </div>
                  <h3 className="text-xl font-bold text-white mb-4">{feature.title}</h3>
                  <p className="text-blue-50 text-[15px] leading-relaxed max-w-[280px] mx-auto font-medium">
                    {feature.desc}
                  </p>
                </div>
              );
