...
export const metadata: Metadata = {
  title: "Legal Disclaimer & DMCA | 4K IPTV USA",
  description: "Legal Disclaimer and DMCA policy for 4K IPTV USA.",
  alternates: {
    canonical: "/dmca",
  },
};
...
const sections = [
  ...
  },
  {
    ...
    content: [
      "4K IPTV USA does not possess, manage, upload, store, or distribute copyrighted materials. All streams available via your account are sourced from external parties on the public internet. Mentions of channels, logos, or trademarks are solely for identification purposes and are owned by their respective entities.",
    ],
  },
  {
    title: "Availability and Service Changes",
    content: [
      <>Channel and VOD options may vary in availability, quality (including 4K/FHD/HD), features, plans, and <Link className="font-semibold text-blue-400 hover:text-blue-300" href="/pricing">pricing</Link>, and can be modified or removed by region without prior notification. We do not assure the availability of any particular <Link className="font-semibold text-blue-400 hover:text-blue-300" href="/channels">channel</Link>, event, or title.</>,
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      "4K IPTV USA, its owners, affiliates, employees, and agents shall not be liable to the fullest extent permitted by law for any indirect, incidental, special, consequential, exemplary, or punitive damages, or for loss of data, profits, or goodwill connected to your use of the site or service.",
    ],
  },
  {
    title: "Indemnification",
    content: [
      "You agree to defend, indemnify, and shield 4K IPTV USA from any claims, liabilities, damages, losses, and expenses (including reasonable attorney fees) related to your use of the service or any infringement of this disclaimer or applicable law.",
    ],
  },
  {
    title: "DMCA Takedown",
    ...
    <main className="flex-grow px-5 pb-20 pt-12 sm:px-8 md:pt-16">
      <article className="mx-auto max-w-4xl">
        <header className="border-b border-black/10 pb-10 text-center mx-auto max-w-3xl">
          <span className="inline-flex rounded-full border border-blue-400/35 bg-blue-400/[0.06] px-4 py-1.5 text-[10px] font-extrabold uppercase tracking-[0.18em] text-blue-300">Legal information</span>
          <h1 className="mt-6 text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.05] tracking-tight">
            <span className="block text-black">Legal Disclaimer</span>
            <span className="mt-1 block text-[#2563EB]">&amp; DMCA Notice.</span>
          </h1>
        ...
        <div className="mt-10 space-y-10 text-base leading-7 text-on-surface-variant">
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-blue-500/20 bg-blue-500/10 p-5 text-sm">
              <strong className="text-black">Important:</strong> 4K IPTV USA delivers an intuitive IPTV service interface alongside account provisioning. We do not host, upload, store, or archive any audiovisual content. The details on this site are provided 'as is' for general guidance, not legal counsel.
            </div>
          </div>
          ...
          <section>
            ...
            <p className="mt-4">For any inquiries, refer to our Terms of Service and <Link className="font-semibold text-blue-400 hover:text-blue-300" href="/privacy-policy">Privacy Policy</Link>, or contact <Link className="font-semibold text-blue-400 hover:text-blue-300" href="/contact">support</Link>.</p>
          </section>
        </div>
      </article>
    </main>
