...
export const metadata: Metadata = {
  title: "Privacy Policy | IPTV Fiesta",
  description: "Learn how IPTV Fiesta collects, uses, and protects personal information.",
  alternates: {
...
const sections = [
  {
    ...
    content: [
      <>We collect personal data that you voluntarily provide when you subscribe to our IPTV service, request information about our products or services, or <Link className="font-semibold text-orange-400 hover:text-orange-300" href="/contact">contact us</Link>. The personal data we collect may include the following:</>,
    ],
    items: [
  ...
  },
  {
    ...
    after: <>To exercise any of these rights, please <Link className="font-semibold text-orange-400 hover:text-orange-300" href="/contact">contact our support team</Link>.</>,
  },
  {
