...
const sections = [
  {
    ...
    content: [
      <>We collect personal data that you voluntarily provide when you subscribe to our IPTV service, request information about our products or services, or <Link className="font-semibold text-blue-400 hover:text-blue-300" href="/contact">contact us</Link>. The personal data we collect may include the following:</>,
    ],
    items: [
  ...
  },
  {
    ...
    after: <>To exercise any of these rights, please <Link className="font-semibold text-blue-400 hover:text-blue-300" href="/contact">contact our support team</Link>.</>,
  },
  {
      ...
      <article className="mx-auto max-w-4xl">
        <header className="border-b border-black/10 pb-10 text-center mx-auto max-w-3xl">
          ...
          <h1 className="mt-6 text-4xl sm:text-5xl lg:text-6xl font-black leading-[1.05] tracking-tight">
            ...
            <span className="mt-1 block text-[#2563EB]">Official Policy.</span>
          </h1>
        ...
        <div className="mt-10 space-y-10 text-base leading-7 text-on-surface-variant">
          <p>Welcome to 4K IPTV USA. We are committed to protecting your personal information and respecting your privacy. If you have questions or concerns about this policy or our data practices, please <Link className="font-semibold text-blue-400 hover:text-blue-300" href="/contact">contact our support team</Link>.</p>
          ...
          <section>
            ...
            <p className="mt-4">If you would like to discuss this policy or our handling of your personal information, please contact our <Link className="font-semibold text-blue-400 hover:text-blue-300" href="/contact">support team</Link>.</p>
          </section>
        </div>
      </article>
    </main>
