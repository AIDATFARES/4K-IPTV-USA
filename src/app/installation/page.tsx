  ...
  return (
    <main className="mx-auto w-full max-w-[1440px] flex-grow px-5 pb-20 pt-12 sm:px-8 md:px-12 text-format-technical">
      <header className="mx-auto mb-16 max-w-3xl text-center sm:mb-20">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-base leading-6 text-slate-600">Comprehensive step-by-step instructions to configure IPTV Fiesta on all your devices.</p>
        <p className="mx-auto mt-2 max-w-2xl text-base leading-6 text-slate-600">IPTV Fiesta works on Smart TVs, Firestick, Android, iOS, MAG, and more. New to IPTV Fiesta? Check <Link className="font-semibold text-orange-400 hover:text-orange-300" href="/pricing">IPTV Fiesta Pricing</Link>, or browse the <Link className="font-semibold text-orange-400 hover:text-orange-300" href="/channels">IPTV Fiesta Channel List</Link> before you start.</p>
      ...
      <section className="mb-20 border-y border-black/[0.07] bg-white/[0.02] py-14 sm:mb-24 sm:py-16">
        <div className="mx-auto max-w-[1000px] px-5">
          <header className="mx-auto mb-10 max-w-[560px] text-center">
            ...
            <p className="mt-3 text-slate-600">Get started with IPTV Fiesta quickly and easily in three straightforward steps.</p>
          </header>
...
function QuickStartCard({ children, icon: Icon, step, title }: { children: React.ReactNode; icon: typeof Download; step: string; title: string }) {
  return (
    <article className="flex flex-col rounded-2xl border-2 border-orange-500 bg-white overflow-hidden shadow-xl hover:-translate-y-1 transition-all duration-300">
      <div className="p-7 text-center flex-1 flex flex-col items-center">
        <Icon className="h-10 w-10 text-orange-400 mb-5" strokeWidth={1.5} />
        <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#FF6B00] text-sm font-extrabold text-white shadow-md mb-3">{step}</span>
